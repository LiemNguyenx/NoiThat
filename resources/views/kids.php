...
<html>
    <head>
        ...
        <title>Trẻ em | Tokuda Furniture</title>
    </head>
    <body>
                                ...
                                while ($lef = $result->fetch_assoc()) {
                                    ...
                                    if ($result2) {
                                        while ($row2 = $result2->fetch_assoc()) {
                                            echo '<a href="catalog.php?id=' . $row2['id'] . '&ppid=6"><p>' . $row2['name'] . '</p></a>';
                                        }
                                    }
                                    else {
                ...
                <div class="product-model-sec">
                    <div class="slider_room">
                        <ul class="rslides" id="slider1">
                            <li><img src="resources/default/images/kids.jpg" alt=""/></li>
                        </ul>
                    </div>  
                </div>
            </div>
