...
<html>
    <head>
        ...
        <title>Phòng làm việc | Tokuda Furniture</title>
    </head>
    <body>
                                ...
                                while ($lef = $result->fetch_assoc()) {
                                    ...
                                    if ($result2) {
                                        while ($row2 = $result2->fetch_assoc()) {
                                            echo '<a href="catalog.php?id=' . $row2['id'] . '&ppid=5"><p>' . $row2['name'] . '</p></a>';
                                        }
                                    }
                                    else {
                ...
                <div class="product-model-sec">
                    <div class="slider_room">
                        <ul class="rslides" id="slider1">
                            <li><img src="resources/default/images/work1.jpg" alt=""/></li>
                            <li><img src="resources/default/images/work2.jpg" alt=""/></li>
                            <li><img src="resources/default/images/work3.jpg" alt=""/></li>
                            <li><img src="resources/default/images/work4.jpg" alt=""/></li>
                            <li><img src="resources/default/images/work5.jpg" alt=""/></li>
                        </ul>
                    </div>  
                </div>
            </div>
